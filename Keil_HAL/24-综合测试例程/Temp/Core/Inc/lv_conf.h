 ...
 */
#define LV_USE_STDLIB_MALLOC    LV_STDLIB_RTTHREAD //LV_STDLIB_BUILTIN
#define LV_USE_STDLIB_STRING    LV_STDLIB_RTTHREAD //LV_STDLIB_BUILTIN
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_RTTHREAD //LV_STDLIB_BUILTIN
...
#define LV_USE_LOG 0 //0 6.RYMCU-hugh
#if LV_USE_LOG
    ...
    *LV_LOG_LEVEL_NONE        Do not log anything*/
    #define LV_LOG_LEVEL LV_LOG_LEVEL_USER //LV_LOG_LEVEL_WARN 7.RYMCU-hugh
...
#define LV_FONT_MONTSERRAT_48 1 //RYMCU-hugh
...
#define LV_USE_SYSMON   0 //0 13.RYMCU-hugh
#if LV_USE_SYSMON
