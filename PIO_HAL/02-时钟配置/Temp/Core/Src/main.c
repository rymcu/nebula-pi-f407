...
int main(void)
{
  ...
  if (systemClock == 168000000) {
      // 主频设置成功
      HAL_GPIO_WritePin(LED2_GPIO_Port,LED2_Pin,GPIO_PIN_RESET);//切换亮灭状
  } else {
      // 主频设置失败
  }
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
    HAL_GPIO_TogglePin(LED1_GPIO_Port,LED1_Pin);//�л�������״̬
    HAL_Delay(500);//��ʱ500ms
    //HAL_GPIO_TogglePin(LED2_GPIO_Port,LED2_Pin);//�л�������״̬
    HAL_Delay(500);//��ʱ500ms
  }
  /* USER CODE END 3 */
}
